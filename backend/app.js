...
mongoose.connect('mongodb+srv://<login>:<password>@eventfinder.chq9z.mongodb.net/<database>?retryWrites=true&w=majority', { useNewUrlParser: true , useUnifiedTopology: true}) //if not working remowe retrywrites
    .then(() => {
